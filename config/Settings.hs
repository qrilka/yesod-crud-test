...
-- declared in the Yesod2.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
--
-- If you change the resource pattern for StaticR in Yesod2.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in Yesod2.hs
staticroot :: Text
